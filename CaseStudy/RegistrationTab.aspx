<%@ Page Title="" Language="C#" MasterPageFile="~/UserSetupInterface.Master" AutoEventWireup="true" CodeBehind="RegistrationTab.aspx.cs" Inherits="CaseStudy.RegistrationTab" %>
...
<!-- Login Page Label -->
<asp:Label ID="Label1" runat="server" Text="Account registration" 
...
<!-- Password Row -->
<div Style="display: flex; align-items: center; margin: 20px 0;">
<asp:Label ID="Label3" runat="server" Text="Create password:" 
    Style="font-size:25px; text-shadow: 0 0 4px white; width: 150px; text-align: center;"/>
...
<asp:Label ID="Label4" runat="server" Text="Confirm password:" 
    Style="font-size:25px; text-shadow: 0 0 4px white; width: 150px; text-align: center;"/>
<asp:TextBox ID="TextBox3" runat="server" Width="250px" TextMode="Password" 
    Style="resize: both; overflow: auto; height: 30px; min-width: 100px;" />
</div>

<asp:Button ID="Button1" runat="server" Text="Create account" 
Style="resize: both; overflow: auto; height: 35px; width: 150px; min-width: 50px; font-size: 20px;" BackColor="#CCFF99" />
