<%@ Page Title="" Language="C#" MasterPageFile="~/UserSetupInterface.Master" AutoEventWireup="true" CodeBehind="AdminLog.aspx.cs" Inherits="CaseStudy.AdminLog" %>
...
<!-- Login Page Label -->
<asp:Label ID="Label1" runat="server" Text="Administrator" 
...
<asp:Label ID="Label2" runat="server" Text="Username:" 
    Style="font-size:25px; text-shadow: 0 0 4px white; width: 150px; text-align: center;" ForeColor="#FF6699"/>
...
Style="resize: both; overflow: auto; height: 35px; width: 100px; min-width: 50px; font-size: 20px;" BackColor="#66CCFF" />
